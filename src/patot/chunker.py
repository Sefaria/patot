...
from .embedding import GeminiEmbedder, l2_normalize_vector
...
from .task_setups import EMBEDDING_001_TASK_SETUPS
...
class PatotChunker:
    ...
    def _chunk_segment_internally(self, segment: SegmentRecord, lang: str) -> tuple[list[PatotChunk], DebugPass2Segment]:
        ...
        if lang == "he":
            ...
            self._debug(f"second_pass_splitter={splitter_name}")
            sentence_splits = sentence_splitter_for_language(lang)(processed)
